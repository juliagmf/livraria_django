...
from livraria.models import Categoria, Autor, Livro
...
# criando função para listar livros, recebe o request do usuario e redireciona para a pagina html como resposta
